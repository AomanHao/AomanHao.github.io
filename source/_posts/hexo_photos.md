...
Hexo博客Next主题相册搭建
<!--more-->
在`blog文件夹/source`下创建`photos`文件夹，在`photos`文件夹创建`index.md`文件，编辑`index.md`文件，写入以下代码:
...
[参考文章，小红鸡](https://me.idealli.com/post/73ad4183.html)
